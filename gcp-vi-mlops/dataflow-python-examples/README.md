...
![Alt text](img/csv_file_to_bigquery.png "CSV file to BigQuery")
...
![Alt text](img/csv_file.png "CSV file")
...
![Alt text](img/custom_python_code.png "Custom Python code")
...
![Alt text](img/output_to_bigquery.png "Output to BigQuery")
...
![Alt text](img/csv_join_bigquery_to_bigquery.png "CSV file joined with BigQuery data to BigQuery")
...
![Alt text](./img/import_state_name_from_bigquery.png "Import state name data from BigQuery")
...
![Alt text](./img/3_custom_python_code.png "Custom python code")
...
![Alt text](img/4_output_to_bigquery.png "Custom python code")
...
![Alt text](img/data_lake_to_data_mart.png "Data lake to data mart")
...
![Alt text](img/1_query_orders.png "Read from BigQuery")
...
### Read in the reference data from BigQuery
![Alt text](img/2_query_account_details.png "Import state name data from BigQuery")
